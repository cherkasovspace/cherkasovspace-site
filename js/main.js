    ...
    function portfolio_init() {
        ...
        if (portfolio_grid) {
            ...
            portfolio_filter.on("click", ".filter", function (e) {
                ...
                if ( ($('#portfolio_filters a').hasClass("noprj")) && (portfolio_grid.lightGallery({selector: '.prj'}))  ){
                portfolio_grid.data('lightGallery').destroy(true);
                }

                else if (portfolio_grid.lightGallery({selector: 'figure'})){
                portfolio_grid.data('lightGallery').destroy(true);
                ...
                portfolio_filter.on("click", ".noproj", function () {
...
$('#portfolio_filters .active').trigger( "click" );
    }
    // /Portfolio subpage filters
